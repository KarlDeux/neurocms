...
define('__NEURO_BASE_URI__', getenv("DOCUMENT_ROOT"));
define('__NEURO_ADMIN_URI__', getenv("DOCUMENT_ROOT") . "/admin/");
define('__SITE_TITLE__', 'Site title');
define('__SITE_DESCRIPTION__', 'Site description');
